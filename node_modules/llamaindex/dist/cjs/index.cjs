...
var workflow = require('@llamaindex/workflow');
...
try {
    ...
    Settings.llm = new openai.OpenAI();
    Settings.embedModel = new openai.OpenAIEmbedding();
}
...
Object.keys(openai).forEach(function (k) {
  if (k !== 'default' && !Object.prototype.hasOwnProperty.call(exports, k)) Object.defineProperty(exports, k, {
    enumerable: true,
    get: function () { return openai[k]; }
  });
});
...
Object.keys(workflow).forEach(function (k) {
  if (k !== 'default' && !Object.prototype.hasOwnProperty.call(exports, k)) Object.defineProperty(exports, k, {
    enumerable: true,
    get: function () { return workflow[k]; }
  });
});
